        ...
        while (opModeIsActive()){
            ...
            if(counter == 6){
                if (VuMarkOutput == RelicRecoveryVuMark.RIGHT) {
                    ...
                    robot.Drive(.35,30,telemetry,elapsedTime,3);
                    counter = 7;
                } else if (VuMarkOutput == RelicRecoveryVuMark.LEFT) {
                    robot.Drive(.35,50,telemetry,elapsedTime,3);
                    counter = 7;
                }
            ...
            if(counter == 10){
                robot.EncoderTurn(Robot.Direction.CounterClockWise,.5,180,elapsedTime,5);
                counter ++;
            }
            if(counter == 11){
                requestOpModeStop();
