...
public class NewBlueSecondaryGyro extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (counter == 6) {
                if (VuMarkOutput == RelicRecoveryVuMark.RIGHT) {
                    robot.Drive(.35, 58, telemetry, 2);
                    counter = 7;
                } else if (VuMarkOutput == RelicRecoveryVuMark.CENTER) {
                    robot.Drive(.35, 38, telemetry, 3);
                    counter = 7;
            ...
            if (counter == 7) {
                robot.GyroTurn(Robot.Direction.CounterClockWise, RobotConstants.RightAngle, .5, telemetry, 3);
                counter++;
            }
            if (counter == 8) {
