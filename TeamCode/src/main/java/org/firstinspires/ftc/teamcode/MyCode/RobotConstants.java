...
public class RobotConstants {
    ...
    public   static final double SqueezerR_Open = .05;
    public   static final double SqueezerL_Open = .95;
    public   static final double SqueezerR_Close = .3;
    public   static final double SqueezerL_Close = .73;
