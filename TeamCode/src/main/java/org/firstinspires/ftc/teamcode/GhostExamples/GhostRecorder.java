...
public class GhostRecorder {
  ...
  public void recordRightBumper(boolean val){buttonValues.setValue(ButtonValues.bumperRight,val);}
  public void recordLeftBumper(boolean val){buttonValues.setValue(ButtonValues.bumperLeft,val);}
